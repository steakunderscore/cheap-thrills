  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested artist" do
        artist = Artist.create! valid_attributes
        put :update, { id: artist.to_param, artist: new_attributes },
            valid_session
        artist.reload
      ...
      it "assigns the requested artist as @artist" do
        artist = Artist.create! valid_attributes
        put :update, { id: artist.to_param, artist: valid_attributes },
            valid_session
        expect(assigns(:artist)).to eq(artist)
      end
    ...
    context "with invalid params" do
      it "assigns the artist as @artist" do
        artist = Artist.create! valid_attributes
        put :update, { id: artist.to_param, artist: invalid_attributes },
            valid_session
        expect(assigns(:artist)).to eq(artist)
      end
